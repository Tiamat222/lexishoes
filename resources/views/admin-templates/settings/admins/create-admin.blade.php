...
@section('title', 'Новый администратор')
@section('content')
<div class="content-wrapper">
@include('layouts.admin-layouts.content-header', ['h1' => 'Новый администратор', 'breadcrumb' => 'create-admin'])
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title" style="margin-top: 7px;">
              <i class="fa fa-plus" aria-hidden="true"></i> Данные администратора
            </h3>
          ...
          <form method="post" action="{{ route('admin.settings.admins.store') }}" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="card-body">
            ...
            <div class="callout callout-warning" style="background:#F5E1B9">
              ...
              - Длина логина от 3 до 20 символов<br>
              - Логин, email и номер телефона должны быть уникальными
            </div>
            <div class="row">
              <div class="col-md-6">
                  ...
                  <div class="card-header" style="background-color:#6c757d;">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="text" name="login" id="login" class="form-control categoty-name" required>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="phone" name="telephone" class="form-control" required>
                      </div>
                      <hr>
                      <div class="form-group">
                        <div class="required">
                          <label class="control-label">Новый пароль<span class="required-field">*</span></label>
                        </div>
                        <input type="password" class="form-control" name="newPwd" id="newPwd" required>
                      </div>
                      <div class="form-group">
                        <div class="required">
                          <label class="control-label">Подтвердите пароль<span class="required-field">*</span></label>
                        </div>
