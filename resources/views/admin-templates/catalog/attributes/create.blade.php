...
<div class="content-wrapper">
  @include('layouts.admin-layouts.content-header', ['h1' => 'Добавление нового атрибута', 'breadcrumb' => 'create-attribute'])
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title" style="margin-top: 7px;">
              <i class="fa fa-plus" aria-hidden="true"></i> Новый атрибут
            </h3>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <div class="required">
                          <label class="control-label">Название атрибута<span class="required-field">*</span></label>
                        </div>
