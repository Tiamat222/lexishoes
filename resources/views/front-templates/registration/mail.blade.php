...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	  ...
	  <title>Регистрация на lexishoes.com.ua</title>
    <style> 
      * { margin: 0; padding: 0; }
      ...
      table.footer { background-color: #ebebeb; padding: 10px 10px 0px 10px; }
      .footer .soc-btn { padding: 3px 7px; font-size: 12px; margin-bottom: 10px; text-decoration: none; color: #FFF; font-weight: bold; display: block; text-align: center; }
      ...
      table .footer tr td p { font-size: 12px; font-weight: bold; }
      ...
      ul.sidebar li a { text-decoration:none; color: #666; padding:10px 16px; margin-right:10px; cursor:pointer; border-bottom: 1px solid #777777; border-top: 1px solid #FFFFFF; display:block; margin:0; }
      ...
      .footer .column { width: 280px; min-width: 279px; float:left; }
      .clear { display: block; clear: both; }
      @media only screen and (max-width: 600px) {
        a[class="btn"] { display:block !important; margin-bottom:10px !important; background-image:none!important; margin-right:0 !important;}
        div[class="column"] { width: auto !important; float:none !important;}
        table.footer div[class="column"] { width:auto !important; }
      }
    </style>
  </head>
  <body bgcolor="#FFFFFF">
	    ...
	    <tr>
          ...
          <div class="content">
            <table>
              <tr>
                <td>
                  <p class="lead">Для завершения регистрации перейдите по этой <a href="{{ route('front.register.check_token', ['token' => $token, 'id' => $id]) }}">ссылке</a>. Ссылка действительна в течение 24 часов.</p>
                  <p class="callout">Если письмо пришло Вам по ошибке, то, вероятно, другой пользователь по ошибке указал ваш адрес электронной почты. Просто удалите письмо.</p>					
                  <table class="footer" width="100%">
                    <tr>
                      <td>
                        <p>Тел: <strong>{{ show_store_phones() }}</strong><br/>
                        Email: <strong><a href="{{ get_setting('manager_email') }}">{{ get_setting('manager_email') }}</a></strong></p>
                      </td>
                    </tr>
                  </table>
                </td>
